...
#define MOISTURE_PIN PIN_PA7      // PA7
#define INTERRUPT_PIN PIN_PA3     // PA3

#define I2C_ADDRESS 0x10     // I2C address of this slave
#define INTERRUPT_PULSE_MS 5 // Duration of interrupt pulse
...
void loop() {
  ...
  delay(50); // Basic debounce + reduce CPU usage
}
